...
class ZF
{
    ...
    protected function _setupToolRuntime()
    {
        ...
        /* "../vendor/" is a HACK for non-standard library folder organization */
        $zfIncludePath['relativePath'] = dirname(__FILE__) . '/../library/vendor/';
    ...
    protected function _tryClientLoad()
    {
        ...
        if (!$fh) {
            ...
            /* HACK for non-require once Zend Framework version */
